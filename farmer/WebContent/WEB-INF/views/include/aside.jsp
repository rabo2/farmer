...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<div class="sidebar">
		...
		<div class="user-panel mt-3 pb-3 mb-3 d-flex">
			...
			<div class="info">
				<div class="row">
					<a href="javascript:OpenWindow('<%=request.getContextPath() %>/member/detail.do?id=${loginUser.id }','내정보','800','700')" class="d-block">${loginUser.name}</a>&nbsp;&nbsp;<br/>
					<button onclick="location.href='<%=request.getContextPath()%>/common/logout.do'" class="btn btn-xs btn-primary col-xs-3" type="button">
					LOGOUT
					</button>
				</div>
